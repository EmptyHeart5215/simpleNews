...
public class TiYuRecyclerAdapter extends BaseAdapter {

    Context context;
    List<TiYuNews.T1348649503389Bean> newslist;

    public TiYuRecyclerAdapter(Context context,   List<TiYuNews.T1348649503389Bean> newslist) {
